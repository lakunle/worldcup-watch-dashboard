const [matches, unitedPlayers, teams, friendlies] = await Promise.all([
  fetch('./data/matches.json?v=202606062235').then(r => r.json()),
  fetch('./data/man-utd-players.json?v=202606062235').then(r => r.json()),
  fetch('./data/teams.json?v=202606062235').then(r => r.json()),
  fetch('./data/friendlies.json?v=202606062235').then(r => r.json()),
]);
